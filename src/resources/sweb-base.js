var sweb = {
    allowExtJs: function () {
        var extjs = sweb_enable_extjs_function();
        console.log(extjs);
        window.$ = extjs[0]
        window.ExtJsObject = extjs[1]
        window.AR = extjs[2]
        window.ExtJsAjaxRequestObject = extjs[3]
        window.IndexOutOfArrayExecption = extjs[4]
        console.log(window.$);
    }
}

function sweb_enable_extjs_function() {
    /**
 * Polyfills
 */
    ...
    */
    ...
    return [$, ExtJsObject, AR, ExtJsAjaxRequestObject, IndexOutOfArrayExecption];
}